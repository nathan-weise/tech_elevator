...
/**
 * This function creates an English sentence from a user's information.
 * This will be diplayed on the profile page.
 * 
...
function declarativeForEach() {
  ...
  myArray.forEach(logTimesTwo); //named function
  myArray.forEach(function(n) {console.log(n * 2);}); //anonymous function
  myArray.forEach((n) => {console.log(n * 2);}); //anonymous function with arrow notation
  myArray.forEach(n => console.log(n * 2)); //simplified arrow notation
}
...
function reduceDemo() {
  ...
  return myArray.reduce((total, num) => total + num, 100);
}
